package com.reactive.api.challenge.appointment.config;
...
public class RabbitConfig {
    ...
    public static final String EXCHANGE = "appointments-exchange-events";
    public static final String ROUTING_KEY = "events.appointments.routing.key";
    ...
    public Queue eventsQueue(){
        return new Queue(APPOINTMENTS_QUEUE);
    }
